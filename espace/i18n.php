...
function i18n_strings(): array {
    ...
    'fr' => [
        ...
        'inst_sub' => "Composition de la Direction, du Conseil Scientifique et du Comité de Pilotage.",
        'inst_public_label' => 'Afficher la rubrique « Instances » sur le site public',
        'inst_state_public' => 'La rubrique est visible par tous les visiteurs du site.',
        'inst_state_hidden' => 'La rubrique est masquée : elle n\'apparaît que sur cette page.',
        'inst_role' => 'Rôle', 'inst_note' => 'Note', 'inst_empty' => 'Aucun membre pour cette instance.',
        'inst_new_name' => 'Nom de la personne (ou texte de la note)',
        'inst_added' => 'Membre ajouté.', 'inst_saved' => 'Modification enregistrée.', 'inst_deleted' => 'Membre supprimé.',
        'inst_up' => 'Monter', 'inst_down' => 'Descendre', 'save' => 'Enregistrer',
        'inst_note_help' => "Cochez « Note » pour une ligne libre sans rôle (par exemple « + représentants du personnel administratif… »). L'ordre d'affichage sur le site suit celui de ces tableaux.",
    ...
    'en' => [
        ...
        'inst_sub' => 'Composition of the Direction, Scientific Council and Steering Committee.',
        'inst_public_label' => 'Show the "Governance" section on the public site',
        'inst_state_public' => 'The section is visible to all site visitors.',
        'inst_state_hidden' => 'The section is hidden: it only appears on this page.',
        'inst_role' => 'Role', 'inst_note' => 'Note', 'inst_empty' => 'No member in this body.',
        'inst_new_name' => 'Person name (or note text)',
        'inst_added' => 'Member added.', 'inst_saved' => 'Change saved.', 'inst_deleted' => 'Member removed.',
        'inst_up' => 'Move up', 'inst_down' => 'Move down', 'save' => 'Save',
        'inst_note_help' => 'Tick "Note" for a free line without a role (e.g. "+ administrative staff representatives…"). The display order on the site follows these tables.',
