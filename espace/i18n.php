...
function i18n_strings(): array {
    ...
    'fr' => [
        ...
        'err_throttled' => "Trop de tentatives de connexion. Réessayez dans 15 minutes.",
        // Inscription
        ...
        'full_name' => 'Nom complet', 'password8' => 'Mot de passe (10+ caractères, lettres et chiffres)',
        ...
        'err_pass8' => 'Le mot de passe doit faire au moins 10 caractères et contenir des lettres et des chiffres.',
        ...
        'err_db_migration' => 'Échec de l\'enregistrement. La base doit être mise à jour. Contactez l\'administrateur.',
        'name_clickable_label' => 'Rendre mon nom cliquable sur le site (vers ma page)',
        'metrics_title' => 'Indicateurs bibliométriques',
        'metrics_manual_label' => 'Saisir mes indicateurs manuellement (sinon récupérés via ORCID/OpenAlex)',
        'metrics_help' => 'Citations, indice h et i10 sont mis à jour automatiquement depuis OpenAlex via votre ORCID (aucune action requise). Cochez la case ci-dessus uniquement si vous préférez les saisir vous-même.',
        'metrics_auto_note' => 'Mise à jour automatique via OpenAlex dès que votre ORCID est renseigné.',
        'metrics_all_done' => 'Indicateurs actualisés pour %d chercheur(s) sur %d.',
        'metrics_refresh_all' => 'Actualiser les indicateurs de tous (OpenAlex)',
        'metrics_refresh_all_help' => 'Met à jour Citations / indice h / i10 de tous les chercheurs ayant un ORCID.',
        'metrics_visibility_label' => 'Afficher les indicateurs bibliométriques sur les pages des chercheurs',
        'metrics_visibility_help' => 'Décochez pour masquer Citations / indice h / i10 sur toutes les pages publiques.',
        'metrics_hidden_note' => 'Les indicateurs sont actuellement masqués sur le site par l\'administration.',
        'recense_title' => 'Recensement des publications',
        'recense_sub' => 'Détection automatique des publications portant l\'affiliation UMR-AMES (via OpenAlex). Vous pouvez corriger manuellement chaque statut.',
        'recense_run' => 'Recenser les affiliations (OpenAlex)',
        'recense_run_help' => 'Analyse les publications de tous les chercheurs ayant un ORCID.',
        'recense_done' => '%d publication(s) analysée(s), dont %d affiliée(s) AMES, pour %d chercheur(s).',
        'recense_filter_label' => 'N\'afficher que les publications affiliées AMES sur le site',
        'recense_filter_help' => 'Désactivé = toutes les publications restent visibles. Activé = filtre strict (liste du site + pages perso).',
        'recense_yes' => 'Affiliée AMES', 'recense_no' => 'Non affiliée', 'recense_unknown' => 'À vérifier', 'recense_manual' => 'manuel',
        'recense_affil' => 'Affiliation détectée', 'recense_status' => 'Statut', 'recense_empty' => 'Aucune publication.',
        'export_from' => 'À partir du', 'export_ames_only' => 'Affiliées AMES uniquement',
        'export_btn' => 'Télécharger en Word',
        'export_help' => 'Génère un document Word de toutes les publications à partir de l\'année choisie (doublons fusionnés).',
        'citations' => 'Citations', 'h_index' => 'Indice h', 'i10_index' => 'Indice i10',
        'metrics_updated_on' => 'mis à jour le', 'metrics_src_manual' => 'Saisie manuelle', 'metrics_src_openalex' => 'Source : OpenAlex',
        'metrics_refresh' => 'Actualiser depuis OpenAlex',
        'metrics_need_orcid' => 'Renseignez d\'abord votre ORCID pour récupérer les indicateurs.',
        'metrics_updated' => 'Indicateurs actualisés depuis OpenAlex.',
        'metrics_failed' => 'Indicateurs introuvables sur OpenAlex pour cet ORCID.',
    ...
    'en' => [
        ...
        'err_throttled' => 'Too many login attempts. Please try again in 15 minutes.',
        ...
        'full_name' => 'Full name', 'password8' => 'Password (10+ characters, letters and digits)',
        ...
        'err_pass8' => 'Password must be at least 10 characters and contain letters and digits.',
        ...
        'err_db_migration' => 'Save failed. The database needs updating. Please contact the administrator.',
        'name_clickable_label' => 'Make my name clickable on the site (to my page)',
        'metrics_title' => 'Bibliometric indicators',
        'metrics_manual_label' => 'Enter my indicators manually (otherwise fetched via ORCID/OpenAlex)',
        'metrics_help' => 'Citations, h-index and i10-index are updated automatically from OpenAlex via your ORCID (no action needed). Tick the box above only if you prefer to enter them yourself.',
        'metrics_auto_note' => 'Automatic update via OpenAlex once your ORCID is set.',
        'metrics_all_done' => 'Indicators refreshed for %d researcher(s) out of %d.',
        'metrics_refresh_all' => 'Refresh everyone\'s indicators (OpenAlex)',
        'metrics_refresh_all_help' => 'Updates Citations / h-index / i10 for all researchers who have an ORCID.',
        'metrics_visibility_label' => 'Show bibliometric indicators on researcher pages',
        'metrics_visibility_help' => 'Uncheck to hide Citations / h-index / i10 on all public pages.',
        'metrics_hidden_note' => 'Indicators are currently hidden on the site by the administration.',
        'recense_title' => 'Publications census',
        'recense_sub' => 'Automatic detection of publications carrying the UMR-AMES affiliation (via OpenAlex). You can override each status manually.',
        'recense_run' => 'Scan affiliations (OpenAlex)',
        'recense_run_help' => 'Analyses publications of all researchers who have an ORCID.',
        'recense_done' => '%d publication(s) analysed, of which %d AMES-affiliated, for %d researcher(s).',
        'recense_filter_label' => 'Show only AMES-affiliated publications on the site',
        'recense_filter_help' => 'Off = all publications stay visible. On = strict filter (site list + personal pages).',
        'recense_yes' => 'AMES-affiliated', 'recense_no' => 'Not affiliated', 'recense_unknown' => 'To check', 'recense_manual' => 'manual',
        'recense_affil' => 'Detected affiliation', 'recense_status' => 'Status', 'recense_empty' => 'No publications.',
        'export_from' => 'From', 'export_ames_only' => 'AMES-affiliated only',
        'export_btn' => 'Download as Word',
        'export_help' => 'Generates a Word document of all publications from the selected year (duplicates merged).',
        'citations' => 'Citations', 'h_index' => 'h-index', 'i10_index' => 'i10-index',
        'metrics_updated_on' => 'updated on', 'metrics_src_manual' => 'Manual entry', 'metrics_src_openalex' => 'Source: OpenAlex',
        'metrics_refresh' => 'Refresh from OpenAlex',
        'metrics_need_orcid' => 'Please fill in your ORCID first to fetch the indicators.',
        'metrics_updated' => 'Indicators refreshed from OpenAlex.',
        'metrics_failed' => 'No indicators found on OpenAlex for this ORCID.',
